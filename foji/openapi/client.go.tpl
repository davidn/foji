...
type (
	ClientAuthenticator         = httputil.ClientAuthenticateFunc[*{{ $.CheckPackage $.Params.Auth $package }}]
	ClientTokenAuthenticator    = httputil.ClientTokenAuthenticatorFunc[*{{ $.CheckPackage $.Params.Auth $package }}]
	ClientBasicAuthenticator    = httputil.ClientBasicAuthenticatorFunc[*{{ $.CheckPackage $.Params.Auth $package }}]
	ClientCookieAuthenticator   = httputil.ClientCookieAuthenticatorFunc[*{{ $.CheckPackage $.Params.Auth $package }}]
	ClientWrappingAuthenticator = httputil.ClientWrappingAuthenticatorFunc[*{{ $.CheckPackage $.Params.Auth $package }}]

{{- if .HasComplexAuth }}
	ClientSecurityGroup  = httputil.ClientSecurityGroup[*{{ $.CheckPackage $.Params.Auth $package }}]
	ClientSecurityGroups = httputil.ClientSecurityGroups[*{{ $.CheckPackage $.Params.Auth $package }}]
{{- end }}
)
